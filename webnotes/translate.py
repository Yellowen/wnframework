...
def translate(lang=None):
    ...
    for lang in languages:
        if lang != "en":
            ...
            if hasattr(conf, "bing_translator_api"):
                print "Translating via Bing Translate..."
                bing_translate(lang, '_lang_tmp.csv', filename)
            else:
...
def bing_translate(lang, infile, outfile):
    """
    translate objects using Bing API. Add you own API key for translation
    """
    data = get_all_messages_from_file(infile)
